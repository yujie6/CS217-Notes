...
\begin{proof}
		...
		.\] 
		In a word, the running time is exactly $O\left( n \right) $. But 
		the constant may varies from the value of $k$, while $k$ get
		closer to $\frac{n}{2}$, the constant will be closer to $2+\log 2$.
\end{proof}
